export const flapTaxTokenV3Abi = [
  {
    ...
    "inputs": [
      {
        "name": "minLiqThreshold_",
        "type": "uint256",
        "internalType": "uint256"
      },
      {
        "name": "startLiqThreshold_",
        "type": "uint256",
        "internalType": "uint256"
      }
    ],
    ...
    "outputs": [
      {
        "name": "currentState",
        "type": "uint8",
        "internalType": "enum IFlapTaxTokenV3.PoolState"
      },
      {
    ...
    "inputs": [
      {
        "name": "params",
        "type": "tuple",
        "internalType": "struct IFlapTaxTokenV3.InitParams",
        "components": [
          {
            "name": "name",
            "type": "string",
  ...
  {
    "type": "error",
    "name": "DividendShareUpdateFailed",
    "inputs": [
      {
        "name": "account",
        "type": "address",
