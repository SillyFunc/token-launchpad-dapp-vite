/**
 * ABI copied from token-launchpad-contracts/out/BuybackVaultFactory.sol/BuybackVaultFactory.sol.json
 ...
 */
export const buybackVaultFactoryAbi = [
  {
    "type": "constructor",
    "inputs": [
      {
